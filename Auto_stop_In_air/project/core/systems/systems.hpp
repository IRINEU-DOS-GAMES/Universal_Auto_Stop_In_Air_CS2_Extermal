...
namespace systems {
	...
	private:
		// CS2 player hitbox order (head/neck/torso, arms, then legs).
		static constexpr int k_bone_map[ ]{ 6, 5, 0, 1, 2, 3, 4, 8, 13, 9, 14, 10, 15, 22, 25, 23, 26, 24, 27 };
	};
	...
	public:
		...
		{
			unknown = 0,
			he_grenade, flashbang, smoke_grenade, molotov, molotov_fire, decoy, planted_c4
		};
